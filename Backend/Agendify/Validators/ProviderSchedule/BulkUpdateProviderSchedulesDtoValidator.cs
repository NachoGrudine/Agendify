...
public class BulkUpdateProviderSchedulesDtoValidator : AbstractValidator<BulkUpdateProviderSchedulesDto>
{
    public BulkUpdateProviderSchedulesDtoValidator()
    {
        RuleFor(x => x.Schedules)
            .NotNull().WithMessage("La lista de horarios es requerida");

        RuleForEach(x => x.Schedules).SetValidator(new ProviderScheduleItemDtoValidator());
    }
}

public class ProviderScheduleItemDtoValidator : AbstractValidator<ProviderScheduleItemDto>
{
    public ProviderScheduleItemDtoValidator()
    {
